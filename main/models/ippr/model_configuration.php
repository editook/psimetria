...
class ModelIpprConfiguration {
    ...
    public function GetValueOrder(
       ...
       $items_pr = [
        [htmlspecialchars("CIENTIFICO")=>["ac"=>$cientifico_ac_pc,"pr"=>$cientifico_pr_pc,"valor" => $cientifico_pr_pc+(15-14+2)*0.001,"interes"=>$this->evaluarInteres($cientifico_pr_pc),"profesion"=>"Profesiones: Geólogo, Biólogo, Astrónomo, Químico, Licenciado en Ciencias Ambientales, Físico."]],
        [htmlspecialchars("TECNICO")=>["ac"=>$tecnico_ac_pc,"pr"=>$tecnico_pr_pc,"valor" => $tecnico_pr_pc+(15-16+2)*0.001,"interes"=>$this->evaluarInteres($tecnico_pr_pc),"profesion"=>"Profesiones: Arquitecto, Aparejador, Ingeniero de Telecomunicación, Aeronáutico, en Electrónica, de Caminos o Industrial. Ingeniero técnico en cualquiera de estas materias."]],
        [htmlspecialchars("SANIDAD")=>["ac"=>$sanidad_ac_pc,"pr"=>$sanidad_pr_pc,"valor" => $sanidad_pr_pc+(15-18+2)*0.001,"interes"=>$this->evaluarInteres($sanidad_pr_pc),"profesion"=>"Profesiones: Médico, Fisioterapeuta, Odontólogo, Dietista, Oftalmólogo. Médico especialista (cardiólogo, pediatra, traumatólogo, etc.), Psicólogo, Psiquiatra."]],
        [htmlspecialchars("CIENTIFICO SOCIAL | HUMANIDADES")=>["ac"=>$cientificosocial_ac_pc,"pr"=>$cientificosocial_pr_pc,"valor" => $cientificosocial_pr_pc+(15-21+2)*0.001,"interes"=>$this->evaluarInteres($cientificosocial_pr_pc),"profesion"=>"Profesiones: Historiador, Especialista en arte (pintura, arquitectura, escultura, etc.), Sociólogo, Filósofo, Trabajador social, Arqueólogo, Antropólogo."]],
        [htmlspecialchars("JURÍDICO SOCIAL")=>["ac"=>$juridicosocial_ac_pc,"pr"=>$juridicosocial_pr_pc,"valor" => $juridicosocial_pr_pc+(15-23+2)*0.001,"interes"=>$this->evaluarInteres($juridicosocial_pr_pc),"profesion"=>"Profesiones: Abogado, Investigador privado, Diplomado en relaciones laborales, Diplomático, Licenciado en Ciencias del Trabajo, Criminólogo."]],
        [htmlspecialchars("COMUNICACION INFORMACION")=>["ac"=>$comunicacion_ac_pc,"pr"=>$comunicacion_pr_pc,"valor" => $comunicacion_pr_pc+(15-26+2)*0.001,"interes"=>$this->evaluarInteres($comunicacion_pr_pc),"profesion"=>"Profesiones: Periodista, Licenciado en Comunicación Audiovisual, Técnico en Imagen o en Sonido, Director-realizador de medios audiovisuales."]],
        [htmlspecialchars("PSICOPEDAGOGICO")=>["ac"=>$psicopedagogia_ac_pc,"pr"=>$psicopedagogia_pr_pc,"valor" => $psicopedagogia_pr_pc+(15-28+2)*0.001,"interes"=>$this->evaluarInteres($psicopedagogia_pr_pc),"profesion"=>"Profesiones: Pedagogo, Psicólogo escolar, Educador social, Maestro de educación especial, Maestro especialista en educación física, Técnico en educación infantil. Profesor (de Primaria, de Bachillerato, etc.)."]],
        [htmlspecialchars("EMPRESARIAL | ADMINISTRATIVO | COMERCIAL")=>["ac"=>$emacesarial_admin_ac_pc,"pr"=>$empresarial_admin_pr_pc,"valor" => $empresarial_admin_pr_pc+(15-31+2)*0.001,"interes"=>$this->evaluarInteres($empresarial_admin_pr_pc),"profesion"=>"Profesiones: Economista, Licenciado en Ciencias Actuariales y Financieras, Técnico en gestión comercial, Administrador de fincas, Agente de la propiedad inmobiliaria. Gestor administrativo."]],
        [htmlspecialchars("INFORMATICA")=>["ac"=>$informatica_ac_pc,"pr"=>$informatica_pr_pc,"valor" => $informatica_pr_pc+(15-33+2)*0.001,"interes"=>$this->evaluarInteres($informatica_pr_pc),"profesion"=>"Profesiones: Ingeniero en informática, Técnico superior en desarrollo de aplicaciones informáticas, Técnico superior en administración de sistemas informáticos, Ingeniero técnico en informática de gestión. Especialista en Telemática (combinación de servicios de informática y telecomunicación)."]],
        [htmlspecialchars("AGRARIO | AGROPECUARIO | AMBIENTAL")=>["ac"=>$agrario_ac_pc,"pr"=>$agrario_pr_pc,"valor" => $agrario_pr_pc+(15-36+2)*0.001,"interes"=>$this->evaluarInteres($agrario_pr_pc),"profesion"=>"Profesiones: Ingeniero agrónomo, Ingeniero de montes, Veterinario, Ingeniero técnico agrícola, Técnico en trabajos forestales y conservación del medio ambiente."]],
        [htmlspecialchars("ARTISTICO - PLASTICO | ARTESANIA | MODA")=>["ac"=>$artistico_plastico_ac_pc,"pr"=>$artistico_plastico_pr_pc,"valor" => $artistico_plastico_pr_pc+(15-38+2)*0.001,"interes"=>$this->evaluarInteres($artistico_plastico_pr_pc),"profesion"=>"Profesiones: Dibujante, Restaurador de bienes culturales, Ilustrador de publicaciones, Diseñador de interiores, Ceramista, Técnico en artes gráficas y diseño. Diseñador de moda."]],
        [htmlspecialchars("ARTÍSTICO MUSICAL | ESPECTÁCULO")=>["ac"=>$artistico_musical_ac_pc,"pr"=>$artistico_musical_pr_pc,"valor" => $artistico_musical_pr_pc+(15-41+2)*0.001,"interes"=>$this->evaluarInteres($artistico_musical_pr_pc),"profesion"=>"Profesiones: Cantante, Actor profesional, Actor de doblaje, Músico instrumentista, Bailarín, Musicólogo."]],
        [htmlspecialchars("FUERZAS ARMADAS | SEGURIDAD | PROTECCION")=>["ac"=>$fuerzas_ac_pc,"pr"=>$fuerzas_pr_pc,"valor" => $fuerzas_pr_pc+(15-43+2)*0.001,"interes"=>$this->evaluarInteres($fuerzas_pr_pc),"profesion"=>"Profesiones: Policía, Vigilante jurado, Oficial de carrera del Ejército, Bombero, Especialista del Ejército, Técnico en salvamento acuático."]],
        [htmlspecialchars("DEPORTIVO")=>["ac"=>$deportes_ac_pc,"pr"=>$deportes_pr_pc,"valor" => $deportes_pr_pc+(15-46+2)*0.001,"interes"=>$this->evaluarInteres($deportes_pr_pc),"profesion"=>"Profesiones: Conductor de actividades deportivas, Técnico deportivo, Licenciado en Ciencias de la Actividad Física, Masajista deportivo, Entrenador, Animador deportivo."]],
        [htmlspecialchars("TURISMO Y HOTELERIA")=>["ac"=>$turismo_ac_pc,"pr"=>$turismo_pr_pc,"valor" => $turismo_pr_pc+(15-48+2)*0.001,"interes"=>$this->evaluarInteres($turismo_pr_pc),"profesion"=>"Profesiones: Técnico de animación turística, Técnico en turismo, Tripulante de cabina o auxiliar de barco, Técnico en información turística. Técnico superior de alojamiento, Técnico en restauración."]]
       ];
