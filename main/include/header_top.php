            ...
            <ul class="nav nav-item  navbar-nav-right ms-auto">
                ...
                <li class="dropdown nav-item main-header-message ">
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-start">
                            <div class="d-flex">
                                <h6 class="dropdown-title mb-1 tx-15 text-white fw-semibold">Mensajes</h6>
                                <span class="badge rounded-pill bg-warning ms-auto my-auto float-end">Marcar como leidos</span>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">Acceso directo a mensajes</p>
                        </div>
                ...
                <li class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-start">
                            <div class="d-flex">
                                <h6 class="dropdown-title mb-1 tx-15 text-white fw-semibold">Notificaciones</h6>
                                <span class="badge rounded-pill bg-warning ms-auto my-auto float-end">Marcar como leidos</span>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">Acceso directo a las notificaciones</p>
                        </div>
